...
import {benevolenceRouter} from '../server/benevolence/router';
import {shareTimeRouter} from '../server/shareTime/router';
...
app.use('/api/benevolence', benevolenceRouter);
app.use('/api/shareTime', shareTimeRouter);
